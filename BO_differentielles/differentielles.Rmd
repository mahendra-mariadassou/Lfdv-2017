...
La différentielle de $x$ notée $dx$ (parfois $\Delta x$ en physique) correspond à une variation **infitésimale** ($\simeq$ toute petite) de $x$
</div>
...
<div class = "definition">
Une <alert>fonction $f$ de plusieurs variables</alert> associe à $(x_1, \dots, x_n) \in \mathbb{R}^n$ un nombre réel $f(x_1, \dots, x_n) \in mathbb$. On la note 
...
$$
Les fonctions correspondantes sont généralement notées $\frac{\partial f}{\partial x}$ et $\frac{\partial f}{\partial x}$. 
</div>
